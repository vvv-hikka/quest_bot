...
WELCOME = (
    ...
    "А сейчас заполни небольшую анкету, чтобы поучаствовать в первом наборе, через нас. Её можно будет изменить в любой момент, но чем больше информации о себе ты предоставишь, тем больше шансов реально получить реальный оффер."
)
