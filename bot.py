...
WELCOME = (
    ...
    "IT-специалистов на работу более эффективным.\n\n"
    "Мы считаем, что текущий процесс найма не даёт достаточно прозрачности "
    "как соискателям, так и HR-специалистам, а AI-инструменты используются неэффективно. Мы хотим это исправить.\n\n"
    ...
    "и сокомандниками с некоммерческих проектов, а также тестирования навыков — для сокращения рисков подделки опыта\n\n"
    f"Наши алгоритмы отсылают мэтчат тебя с HR-ами компаний, а тебе придут только приглашения на собеседование. \n\nВ нашем телеграм-канале {CHANNEL_USERNAME} ты можешь следить за обновлениями, "
    "а в комментариях канала мы отвечаем на ваши вопросы и предложения о сотрудничестве.\n\n"
    "🚀 <b>Запуск совсем скоро!</b>\n\n"
    "А сейчас заполни небольшую анкету, чтобы поучаствовать в первом наборе, через нас. Если что, её можно будет изменить в любой момент, но чем больше информации о себе ты предоставишь, тем больше шансов реально получить реальный оффер."
)
